#!/usr/bin/env python3
"""
quiz.py — Neo4j Agent Memory — SDKs, MCP, and Graph-Native Persistence.
...
# ---------------------------------------------------------------------------
# LEGACY QUESTION BANK — retained only as an engine fixture; never presented
...
# The interaction and scoring engine is shared with an earlier lesson. This
# lesson's independently reviewable question bank is the active bank.
from agent_memory_questions import CATEGORY_LABELS, QUESTIONS  # noqa: E402
...
def main():
    parser = argparse.ArgumentParser(
        description="Neo4j Agent Memory — SDKs, MCP, and Graph-Native Persistence comprehension quiz."
    )
    parser.add_argument(
    ...
    print("=" * 68)
    print("  Neo4j Agent Memory — SDKs, MCP, and Graph-Native Persistence")
    print("  Pre/Post Comprehension Check")
    print("=" * 68)
