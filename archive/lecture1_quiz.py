...
QUESTIONS = [
    ...
    },
    {
        ...
        "choices": [
            ...
            "It lets the model track how far into training it currently is",
            "It ensures every token attends equally to all other positions regardless of distance",
            "It compresses a long sequence into a single fixed-length summary vector",
        ],
        "answer": 0,
        "explanation": "Without positional information, \"dog bites man\" and \"man bites dog\" would look identical to attention — this is a different \"position\" than training progress, and the opposite of forcing equal attention everywhere.",
    },
    {
        "id": "arch5",
        "category": "architecture",
